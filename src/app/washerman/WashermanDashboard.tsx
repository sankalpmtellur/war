...
export default function WashermanDashboard() {
  ...
  const saveEdit = () => {
    ...
    setSaving(true);
    // In a real app, this would update the backend
    console.log(`Updating order ${editingOrderId} to have ${parsed} clothes`);
    setSaving(false);
    cancelEdit();
  };
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full border rounded-xl pl-10 pr-4 py-2.5 text-gray-700 focus:ring-2 focus:ring-[#a30c34] outline-none shadow-sm"
                value={searchTerm}
